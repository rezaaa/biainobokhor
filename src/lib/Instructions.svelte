...
<div class="steps">
  ...
  <div class="privacy">
    ...
    <p>
     کد این سرویس منتشر شده و کارکرد آن مشخص است، لطفا در موارد مشابه، توکن (کلید دسترسی به اطلاعات)  را بدون بررسی و اطمینان به هر سرویسی ارسال نکنید.
    </p>
    <p>
      سازنده‌ی این سرویس هیچ مسئولیتی در برابر سوء استفاده‌ی دیگران از سورس کد منتشر شده ندارد.
    </p>
  </div>
</div>
<Logos />
